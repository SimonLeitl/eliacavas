        ...
        <section class="beschreibung" style="padding-right:15%; padding-left:15%;">
            ...
            <div class="row justify-content-center" style="padding-bottom:20%; width:100%;">
                ...
                <div class="col-lg text">
                    ...
                    <hr />
                    <p class="text">
                        Dein Produkt wird sich besser verkaufen, wenn du deiner Zielgruppe alle Vorteile
            ...
            <div class="row justify-content-center" style="padding-bottom:20%; width:100%;">
                <div class="col-lg text">
                    ...
                    <hr />
                    <p class="text">
                        95% der Kaufentscheidungen werden durch Emotionen im Unterbewusstsein
            ...
            <div class="row justify-content-center" style="padding-bottom:20%; width:100%;">
                ...
                <div class="col-lg text" >
                    ...
                    <hr />
                    <p class="text">
                        Dein Kunde nimmt deine Produktdarstellung schneller und vertrauenswürdiger
